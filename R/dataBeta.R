...
#'
#' @description A dataset to simulate Small Area Estimation using Hierarchical Bayesian method under Two Fold Subarea level model with Beta distribution on variabel interest.
#'
#' This data is generated by these following steps:
#' \enumerate{
#'   \item Generate auxiliary variabel \eqn{X_{ij1},X_{ij2}}, sampling error \eqn{e_{ij}},subarea random effect \eqn{u_{ij}}, area random effect \eqn{v_{i}}, and weight or proportions of unit \eqn{w_{ij}}
#'   \itemize{
#'    \item Generate auxilary variabel on subarea level \eqn{X_{ij1}}~ \eqn{U(0,1)}
#'    \item Generate auxilary variabel on subarea level \eqn{X_{ij2}}~\eqn{N(0,1)}
