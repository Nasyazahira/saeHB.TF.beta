...
static constexpr std::array<const char*, 60> locations_array__ =
  ...
  " (in 'string', line 36, column 4 to column 81)",
  " (in 'string', line 37, column 4 to column 26)",
  " (in 'string', line 38, column 4 to column 32)",
  " (in 'string', line 35, column 17 to line 39, column 3)",
  " (in 'string', line 35, column 2 to line 39, column 3)",
  ...
  " (in 'string', line 49, column 20 to line 51, column 3)",
  ...
  " (in 'string', line 59, column 4 to column 28)",
  ...
  " (in 'string', line 24, column 9 to column 13)",
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      auto u = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(n);
      current_statement__ = 2;
      auto f = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(m);
      current_statement__ = 3;
      auto b = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(nvar);
